...
export function Manifesto() {
  ...
  return (
    <section id="approach" className="scroll-mt-24 border-t border-border py-16 sm:py-24">
      <Container>
        ...
        <p className="display-statement mt-6 max-w-4xl text-ink">{t('statement')}</p>
        ...
        <ul className="mt-10 grid gap-px overflow-hidden rounded-card border border-border bg-border sm:grid-cols-2 lg:grid-cols-4">
          {principles.map((id) => (

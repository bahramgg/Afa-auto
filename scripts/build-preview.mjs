...
/* The preview bar is dev-only chrome and cannot import the app's tokens, so
   these are literals by necessity. Kept in step with afa-tokens.css by hand —
   blue-400 / violet-400. */
.pv-tab.is-active{background:linear-gradient(120deg,#5a7bff,#9a6bff);color:#fff;border-color:#2b3058}
